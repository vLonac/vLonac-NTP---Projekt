...
__interface INTERFACE_UUID("{187BA98E-BD3B-4D8B-A0DC-EE622776C4AA}") IXMLusersType : public Xml::Xmlintf::IXMLNodeCollection
{
public:
public:
  // Property Accessors 
...
__interface INTERFACE_UUID("{5A919879-02DE-461E-A05F-B71BC40513DD}") IXMLuserType : public Xml::Xmlintf::IXMLNode
{
public:
  // Property Accessors 
